        ...
        $node
            ...
            ->children()
                ...
                ->arrayNode('configuration')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('max_questions')->cannotBeEmpty()->isRequired()->end()
                        ->arrayNode('question_level')
                            ->useAttributeAsKey('level')
                            ->prototype('scalar')->end()
                        ->end()
                        ->scalarNode('answers_max')->cannotBeEmpty()->isRequired()->end()
                        ->scalarNode('timeout')->cannotBeEmpty()->isRequired()->end()
                        ->scalarNode('time_per_question')->cannotBeEmpty()->isRequired()->end()
                    ->end()
                ->end()
            ->end();
    }
